Modernizr.addTest("retina", function() {
    ...
    t.fn.RMAltText = function(e) {
        var i = [], s = "rmalttext", n = {
            ...
            function a(e) {
                ...
                s = 0, n = !0), v = setTimeout(r.bind(i[0], n), s);
            }
            function o() {
                clearTimeout(v), clearInterval(w), v = setTimeout(function() {
                    window.rmalt_current_shown = null, f && f.fadeOut(150, function() {
                        f.remove(), f = void 0;
                    });
                }, 400);
            }
            function r(e) {
                var s = e ? 0 : 200;
                if (clearTimeout(v), clearInterval(w), !(i.hasClass("rmalttext-disable") || i.hasClass("active") || i.hasClass("disabled") || i.hasClass("no-hover"))) {
                    if (!f) {
                        (f = t(y).appendTo(g)).find(".rmalttext-content").text(i.attr("data-alt"));
                        var n = i.attr("data-alt-style") || p.cssClass;
                        n && f.addClass(n), f.css({
                            display: "none"
                        }), d();
                    }
                    f.fadeIn(s), window.rmalt_current_shown = i, w = setInterval(function() {
                        i instanceof jQuery && u(i) || h();
                    }.bind(i), 200);
                }
            }
            function l(e) {
            ...
            function c(t, e) {
                var i, s;
                return "top" == (t = t || p.direction) && (i = e.targetX + (e.targetW - e.tipW) / 2, s = e.targetY - e.offset - e.tipH), 
            ...
            function d() {
                f || this.destroy();
                var t = g[0].getBoundingClientRect(), e = i[0].getBoundingClientRect(), s = i.attr("data-alt-pos") || p.direction, a = {
                    offset: i.attr("data-alt-offset") ? i.attr("data-alt-offset") - 0 : p.offset,
                    tipW: f.outerWidth(!1),
                    tipH: f.outerHeight(!1),
                    targetX: e.left,
                    targetY: e.top,
                    containerX: t.left,
                    containerY: t.top,
                ...
                if (p.keepInBounds && !l(o)) {
                    var r = n[s], d = [ r ].concat(_.without(_.keys(n), s, r));
                    o = c(s = (s = _.find(d, function(t) {
                        return l(c(t, a));
                    })) || "top", a);
                }
                f.addClass("rmalttext-" + s), f.css({
                    left: o.relativeLeft,
                    top: o.relativeTop
                });
            }
            function h() {
                clearTimeout(v), clearInterval(w), window.rmalt_current_shown = null, f && f.remove(), f = void 0;
            }
            function u(t) {
            ...
            e && t.extend(p, e);
            var g = p.container && p.container.length ? p.container : t("body");
            if ((!i.hasClass(s) || p.text) && Modernizr.isdesktop) {
                i.addClass(s);
                var m = i.attr("data-alt") || p.text;
                if (m) {
                    var f, v, w, y = '<div class="rmalttext-wrapper">\t\t\t\t\t\t\t\t\t\t<div class="rmalttext-content">' + m + '</div>\t\t\t\t\t\t\t\t\t\t<div class="rmalttext-corner-wrapper"><div class="rmalttext-corner"></div></div>\t\t\t\t\t\t\t\t\t</div>';
                    return p.manual || i.on("mouseenter", a).on("mouseleave", o).on("click", h).on("rmalt-hide", h), i.on("DOMNodeRemovedFromDocument", h), 
                    {
                        hide: h,
                        show: r,
                        update: d,
    ...
    function n(i, n) {
        var a, o, r = t.Popcorn;
        if (w = "loading", !r || s(i, r.version) > 0 || n(r, w = "loaded")) {
            var l = e.createElement("script");
            l.type = "text/javascript", l.src = "/js/libs/popcorn.min.js", l.onload = l.onreadystatechange = function() {
                "loading" != w || (a = this.readyState) && "loaded" != a && "complete" != a || (o = t.Popcorn, r && (t.Popcorn = r), 
                n(o, w = "loaded"), f.removeChild(l));
            }, f.appendChild(l);
        }
    }
    function a(i, n) {
        var a, o = t.SC;
        if (_ = "loading", !o || !o.Dialog || s(i, o._version) > 0 || n(o, _ = "loaded")) {
            var r = e.createElement("script");
            r.type = "text/javascript", r.src = "//connect.soundcloud.com/sdk-2.0.0.js", r.onload = r.onreadystatechange = function() {
                "loading" != _ || (a = this.readyState) && "loaded" != a && "complete" != a || (n(t.SC, _ = "loaded"), 
                f.removeChild(r));
            }, f.appendChild(r);
        }
    }
    ...
    function l(t) {
        for (var e = 0; e < v.length; e++) v[e].playing && (t && t.el === v[e].el || v[e].pause());
    }
    function c(t) {
        ...
        this.playing = !1, this.sound = null, this.click_handler_binded = k(this.click_handler, this), v.push(this);
    }
    function d(t) {
        c.apply(this, Array.prototype.slice.call(arguments)), this.id = t.getAttribute("data-id"), "initialized" !== _ && (g.initialize({
            client_id: "5ba7fd66044a60db41a97cb9d924996a"
        }), _ = "initialized"), g.stream(this.id, k(function(t) {
            this.destroyed ? t._player.kill && t._player.kill() : (this.sound = t, this.sound._player.on("positionChange", k(function(t) {
    ...
    function h(t) {
        c.apply(this, Array.prototype.slice.call(arguments)), this.id = "soundcite-audio-" + this.generateUUID(), 
        this.url = t.getAttribute("data-url"), this.start = Math.floor(this.start / 1e3), null !== this.end && (this.end = Math.floor(this.end / 1e3)), 
        "initialized" != w && (soundcite.audio_container = e.createElement("div"), r(soundcite.audio_container, "soundcite-audio"), 
        e.getElementsByTagName("body")[0].appendChild(soundcite.audio_container), w = "initialized"), this.audio = e.createElement("audio"), 
        this.audio.id = this.id, this.audio.setAttribute("src", this.url), this.audio.setAttribute("preload", "none"), 
        soundcite.mobile = !0, soundcite.audio_container.appendChild(this.audio), this.sound = m("#" + this.id, {
            frameAnimation: !0
        }), this.sound.on("loadeddata", k(function() {
    ...
    for (var p in t.SOUNDCITE_CONFIG) u[p] = t.SOUNDCITE_CONFIG[p];
    ...
    var g, m, f = e.head || e.getElementsByTagName("head").item(0) || e.documentElement.childNodes[0], v = [], _ = "none", w = "none", y = [], b = [], k = function(t, e) {
        var i = Array.prototype.slice, s = i.call(arguments, 2);
        return function() {
            return t.apply(e, s.concat(i.call(arguments)));
        };
    };
    c.prototype.generateUUID = function() {
        var t = new Date().getTime();
        return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(e) {
            var i = (t + 16 * Math.random()) % 16 | 0;
            return t = Math.floor(t / 16), ("x" == e ? i : 3 & i | 8).toString(16);
        });
    }, c.prototype.sound_loaded = function() {
        this.el.addEventListener("click", this.click_handler_binded), o(this.el, "soundcite-initializing"), 
        this.el.style.display = "none", this.el.offsetHeight, this.el.style.display = "", r(this.el, "soundcite-loaded soundcite-play");
    }, c.prototype.pause = function() {
        o(this.el, "soundcite-pause"), r(this.el, "soundcite-play"), this.playing = !1, this.pause_sound();
    }, c.prototype.stop = function() {
        o(this.el, "soundcite-pause"), r(this.el, "soundcite-play"), this.playing = !1, this.plays_left = this.plays, 
        this.stop_sound();
    }, c.prototype.track_progress = function() {
        var t = this.end - this.start, e = 100 * (this.sound_position() - this.start) / t;
        this.color || (this.color = i(this.el)), u.update_playing_element(this.el, e, this.color);
    }, c.prototype.click_handler = function(t) {
        t.preventDefault(), l(this), this.playing ? this.pause() : this.play();
    }, c.prototype.destroy = function(t) {
        this.destroyed = !0, this.playing && this.pause(), this.el && o(this.el, "soundcite-loaded soundcite-initializing soundcite-loading soundcite-play soundcite-pause"), 
        this.el && this.el.removeEventListener("click", this.click_handler_binded);
    }, (d.prototype = Object.create(c.prototype)).sound_position = function() {
        return this.sound.getCurrentPosition();
    }, d.prototype.pause_sound = function() {
        this.sound.pause();
    }, d.prototype.stop_sound = function() {
        this.sound.stop();
    }, d.prototype.play = function() {
        var t = this.sound_position();
        (t < this.start || t >= this.end) && this.sound.seek(this.start), o(this.el, "soundcite-play"), r(this.el, "soundcite-pause"), 
        this.sound.play(), this.playing = !0, this.prevPos = -1;
    }, d.prototype.destroy = function() {
        this.sound && this.sound._player.kill && this.sound._player.kill(), c.prototype.destroy.apply(this, arguments);
    }, (h.prototype = Object.create(c.prototype)).sound_position = function() {
        return this.sound.currentTime();
    }, h.prototype.pause_sound = function() {
        this.sound.pause(), this.sound.off("timeupdate");
    }, h.prototype.stop_sound = function() {
        this.sound.off("timeupdate"), this.sound.pause();
    }, h.prototype._play_sound = function() {
        o(this.el, "soundcite-loading soundcite-play"), r(this.el, "soundcite-pause"), this.sound.play(), this.playing = !0, 
        this.sound.on("timeupdate", k(function() {
    ...
    }, h.prototype.play_sound = function() {
        var t = this.sound.currentTime();
        t < this.start || t >= this.end ? (this.sound.on("seeked", k(function() {
            this.sound.off("seeked"), this._play_sound();
        }, this)), this.sound.currentTime(this.start)) : this._play_sound();
    }, h.prototype.play = function() {
        /soundcite\-loading/.test(this.el.className) || (soundcite.mobile ? (o(this.el, "soundcite-play"), r(this.el, "soundcite-loading"), 
        this.startedLoading ? this.play_sound() : (this.sound.on("canplaythrough", k(function() {
            this.play_sound();
        }, this)), e.getElementById(this.id).load()), this.startedLoading = !0) : this.play_sound());
    }, h.prototype.destroy = function() {
        this.sound && m.destroy(this.sound), this.audio && soundcite.audio_container.removeChild(this.audio), 
        c.prototype.destroy.apply(this, arguments);
    }, soundcite.createPlayer = function(t) {
        r(t, "soundcite-initializing"), r(t, "soundcite-force-bg-color"), u.update_playing_element(t, 0, i(t)), 
        t.getAttribute("data-url") && ("none" == w ? (b.push(t), n("1.5.6", function(t) {
            m = t;
            for (var e = 0; e < b.length; e++) new h(b[e]);
        })) : "loading" == w ? b.push(t) : new h(t)), t.getAttribute("data-id") && ("none" == _ ? (y.push(t), 
        a("2.0.0", function(t) {
            g = t;
            for (var e = 0; e < y.length; e++) new d(y[e]);
        })) : "loading" == _ ? y.push(t) : new d(t));
    }, soundcite.destroyPlayer = function(t) {
        for (e = v.length - 1; e >= 0; e--) v[e].el == t && (v[e].destroy(), v.splice(e, 1));
        for (e = b.length - 1; e >= 0; e--) b[e] == t && b.splice(e, 1);
        for (var e = y.length - 1; e >= 0; e--) y[e] == t && y.splice(e, 1);
    }, soundcite.pausePlayer = function(t) {
        for (var e = 0; e < v.length; e++) t == v[e].el && v[e].playing && v[e].pause();
    }, soundcite.setElementsColor = function(t) {
        u.update_playing_element(t, 0, i(t));
    };
    ...
    t.constants = _.extend({
        ...
        declination: function(t, e, i, s, n) {
            var a = [ t, e, i ], o = s % 100;
            return o = o >= 11 && o <= 14 ? 0 : (o %= 10) < 5 ? o > 2 ? 2 : o : 0, n || (o = 1 == s ? 1 : 0), a[o];
        },
        ...
        simulateEvent: function(t, e) {
            ...
            return document.createEvent ? (s = document.createEvent(o), "HTMLEvents" == o ? s.initEvent(e, a.bubbles, a.cancelable) : s.initMouseEvent(e, a.bubbles, a.cancelable, document.defaultView, a.button, a.pointerX, a.pointerY, a.pointerX, a.pointerY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, a.button, t), 
            t.dispatchEvent(s)) : (a.clientX = a.pointerX, a.clientY = a.pointerY, s = i(document.createEventObject(), a), 
            t.fireEvent("on" + e, s)), t;
        },
        ...
        deepExtend: function(t) {
            var e, i = /#{\s*?_\s*?}/, s = function(t, e) {
                ...
                return _.isString(e), t[n] = s.replace(i, e);
            }, r = function(t, e) {
                ...
                return t[s] = _.deepExtend(e, i);
            }, c = function(i) {
                var c = t[i], d = e[i];
                s(c, d) ? n(0, d, i) : a(0, d) ? o(c, d, i) : r(c, d) ? n(0, d, i) : _.isObject(c) && _.isObject(d) ? l(c, d, i) : n(0, d, i);
            };
            return _.each(Array.prototype.slice.call(arguments, 1), function(t) {
                e = t, Object.keys(e).forEach(c);
            }), t;
        }
    });
    if (jQuery.fn.selectText = function() {
        ...
        var t = [ "$", "^", "*", "(", ")", "+", "[", "]", "{", "}", "\\", "|", ".", "?", "/" ], e = new RegExp("(\\" + t.join("|\\") + ")", "g");
        return this.replace(e, "\\$1");
    ...
    t.textutils = {
        ...
        generateCSS: function(t, e, i, s, n) {
            if (s) {
                ...
                _.each(s, function(e) {
                    "paragraph" == t && (r += _.map(a, function(t) {
                        return t + "." + e._name;
                        ...
                        indentation: !0,
                        lineBreaks: !0
                    }), r += "}\n\n"), "link" == t && (n.forcePseudoState && n.forcePseudoClass == e._name ? (r += _.map(a, function(t) {
                        return t + "." + e._name;
                    }).join(",\n") + " {\n", r += o.generateStylesStr({
                        tp: t,
                        style: e,
            ...
            _.each(r, function(n, a) {
                ...
                for (o = 0; o < p; o++) {
                    ...
                    if ("webtype" == a) {
                        ...
                        $('link.fonts[data-provider="webtype"]').length || s(m + (f = window.ServerData && window.ServerData.fonts && window.ServerData.fonts.webtype));
                    }
                    if ("typetoday" == a && !d) {
        ...
        exactWaitForFontLoad: function(t, s, n, a) {
            function o() {
                var l = +new Date() - v > i, c = r();
                if (c || l) return g = void 0, u.remove(), void a(c, t, s, n);
                setTimeout(o, e);
            }
            function r() {
                var t = l;
                g.clearRect(0, 0, d, h), m || (m = p.toDataURL("image/png"), t = c), g.font = t, g.fillStyle = "000", 
                g.fillText("a1-&q", 0, 20);
                var e = p.toDataURL("image/png");
                return f || (f = e), e != m && e != f;
            }
            var l = n + " " + s + " 12px " + t + ", Arial", c = n + " " + s + " 12px Arial", d = 20, h = 20, u = $('<canvas width="' + d + '" height="' + h + '"></canvas>'), p = u[0], g = p.getContext("2d"), m = "", f = "", v = +new Date();
            u.appendTo("body").css({
                position: "absolute",
                left: 0,
                top: "-999px"
...
"undefined" == typeof RM && (RM = {}), function(t) {
    ...
    t.classes.embedplugins = t.classes.embedplugins || {}, t.embedutils = t.embedutils || {}, t.embedutils.findPlugin = function(e) {
        ...
        resizable: !0,
        parse: function(t, e) {
            var i, s = /[\s\S]*?(\<iframe[\s\S]*?\>)[\s\S]*?(\<\/iframe\>)[\s\S]*?/i;
            return i = t.match(s), e(i && i[1] && i[2] ? i[1] + i[2] : null);
        },
        sanitize: function(t) {
            var e = $(t);
    ...
    t.classes.GiftView = Backbone.View.extend({
        ...
        onSendButtonClick: function() {
            function t(t) {
                var e = [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ], i = t.split("-");
                return e[i[1] - 1] + " " + parseInt(i[2]) + ", " + parseInt(i[0]);
            }
            this.clearAllErrors();
            var e = new this.Model(), i = this.getFormData();
            if (i.hasErrors) return i.$errorFields.addClass("show-error"), this.$(".bottom-block").find(".error").text("PLEASE CHECK THE FIELDS ABOVE MARKED WITH RED"), 
            ...
            var s = {
                success: function(e) {
                    ...
                    this.$(".congrats-wrapper .subscription .caption").html("1 " + i.period.capitalize() + " of<br>Super Publisher"), 
                    this.$(".congrats-wrapper .subscription .price").text("$" + Math.round(e.get("amount") / 100)), this.$(".congrats-wrapper .order-info .info-email").text(e.get("deliver_email")), 
                    this.$(".congrats-wrapper .order-info .info-date").text(t(e.get("deliver_at"))), this.$(".congrats-wrapper .order-info .info-code").text(e.get("code")), 
                    Modernizr.isphone && this.router && this.router.mag && this.router.mag.setScrollPosition({
                        delta: this.$(".back-button").offset().top - this.$(".send-button").offset().top,
                        animate: !0
                    }), this.router && this.router.analytics && this.router.analytics.sendEvent("Gift Code Purchase", "superpublisher_" + i.period + "ly"), 
                    n();
                }.bind(this),
                error: function(t, e) {
                    this.showStripeError(e.responseText), n();
                }.bind(this)
            }, n = function() {
                this.$(".bottom-block .send-button").removeClass("show-loader"), this.$(".charging-overlay").hide(), 
                this.$el.off("keydown");
            }.bind(this), a = _.pick(i, "plan_id", "deliver_at", "deliver_message", "deliver_email", "from_name");
            _.isEmpty(i.card) ? e.save(a, s) : this.stripe.card.createToken(i.card, function(t, i) {
                i.error ? (this.showStripeError(i.error && i.error.message || "Sorry, some problems with your card."), 
                n()) : (a.card_token = i.id, e.save(a, s));
            }.bind(this));
        },
    ...
    var e = window.performance || {}, i = Date.now ? Date.now() : +new Date(), s = [], n = {}, a = function(t, e) {
    ...
    t.classes.Share = Backbone.View.extend({
        ...
        updateEmbed: function() {
            var e, i = this.mag.currentPage || this.mag.pages[0], s = this.$(".size-selector").attr("data-selected"), n = {
        ...
        onTypeSelectorClick: function(t) {
            ...
            } else "page" == (this.$(".type-selector").attr("data-tp") || "page") ? this.selectFullMode() : this.selectPageMode();
        },
    ...
    t.classes.Page = Backbone.View.extend({
        ...
        render: function() {
            ...
            })), this.$el.appendTo(this.$container), this.zIndex = this.totalPages - this.num + 2, "vertical" == this.viewerType && this.$el.css("z-index", this.zIndex), 
        ...
        createWidgetsForCurrentViewport: function() {
            ...
            _.each(this.widgetsData, function(i) {
                ...
                e.fixed_position && (e.z < n || Modernizr.isdesktop) ? e.$fixedContainer = o.$fixedPositionContainer : e.$fixedContainer = o.$fixedPositionContainerTop;
                ...
                i.push(s));
            }), this.animations = new t.classes.Animations({
                page: this,
                widgets: i
            ...
            }, 0), this.hasFixedWidgets = !!this.fixedWidgets.length, this.$el.removeClass("page-with-fixeds-desktop page-with-fixeds-mobile").toggleClass("page-with-fixeds-desktop", this.hasFixedWidgets && Modernizr.isdesktop).toggleClass("page-with-fixeds-mobile", this.hasFixedWidgets && !Modernizr.isdesktop), 
        ...
        signalOnLoading: function() {
            function t() {
                "background" == this.type && s.destroyLQBackground({
                    animate: !0
                }), i--, this.hasLoadAnimation() && (s._widgetsWithLoadAnimation--, s._widgetsWithLoadAnimation || (s.loadAnimationsReady = !0, 
                s.trigger("loadAnimationsReady"))), i || (s.fireReadyTimeout = setTimeout(e, 200));
            }
            function e() {
                s.loaded = !0, s.trigger("pageLoaded");
            }
            var i = this.widgets.length, s = this;
            _.each(this.widgets, function(e) {
                e.on("loaded", t, e);
            }, this), this.BGWidget && this.hasVideoBG && this.BGWidget.on("videoBGStarted", function() {
                s.videoBGStarted = !0, _.delay(function() {
                    s.trigger("videoBGStarted");
                }, 1300);
            }, this.BGWidget), 0 == i && (this.fireReadyTimeout = setTimeout(e, 200));
        },
        ...
        createLQBackground: function() {
            if (!t.screenshot) {
                ...
                if (this.$fixedBgContainer.css("background-color", "#" + e.color), e.picture && "picture" == e.selectedType && e.picture.poorUrl || e.video && "video" == e.selectedType && e.video.thumbnail_url) {
                    ...
                    }, this)).attr("src", this.LQBG.picture.poorUrl), "video" == this.LQBG.selectedType) {
    ...
    t.classes.FinalPage = Backbone.View.extend({
        ...
        updateEmbed: function() {
            var e = this.$(".size-selector").attr("data-selected"), i = {
                responsive: "responsive",
                big: 512,
                small: 288
            };
    ...
    t.classes.Mag = Backbone.View.extend({
        ...
        initialize: function(e, i) {
            ...
            this.onMagScroll.__throttled = _.throttle(this.onMagScroll, 100), this.redrawAboveGlobalWidgets.__debounced = _.debounce(this.redrawAboveGlobalWidgets, 500, !0), 
            this.widgetPackCount = 0, this.getAboveGlobalBoxMemoized = _.memoize(this.getAboveGlobalBox, function(t, e, i) {
        ...
        setViewerOptions: function(e) {
            ...
            "vertical" != i.viewertype || Modernizr.isdesktop || (this.isStickyVerticalViewer = Modernizr.csspositionsticky, 
        ...
        render: function() {
            ...
            if (!this.active) {
                ...
                $(window).on("gesturestart gestureend", this.onGestureChange), "vertical" == this.viewOpts.viewertype && this.$magScrollHandler.on("scroll", this.isStickyVerticalViewer ? this.onMagScroll.__throttled : this.onMagScroll), 
        ...
        destroy: function() {
            ...
            "vertical" == this.viewOpts.viewertype && this.$magScrollHandler.off("scroll", this.isStickyVerticalViewer ? this.onMagScroll.__throttled : this.onMagScroll), 
            $("body").off("keyup", this.onKeyup), this.active = !1, this.remove();
        },
        getUrl: function() {
        ...
        onPageVisibilityChange: function() {
            if (this.currentPage) if (t.utils.PageVisibilityManager.isPageHidden()) this.currentPage.stop({
                widgetTypes: [ "video", "background", "iframe" ]
            }), (e = this.getPage(this.currentPage.num + 1)) && e.started && (e.stop({
                widgetTypes: [ "video", "background", "iframe" ]
            }), this.restartNextPage = !0); else {
        ...
        onDragMove: function(e) {
            ...
            if (!(e.originalEvent.touches.length > 1) && i) if ("horizontal" == this.viewOpts.viewertype ? this.currentPage && this.currentPage.hasFixedWidgets && $(e.target).closest(this.$mag_container).length && !i.$target.length && (i.$target = this.currentPage.$scrollWrapper) : i.$target.length || (i.$target = this.$magScrollContainer), 
            i.$target.length) {
        ...
        onVerticalViewKeyDown: function(t) {
            if (!this.isInPresentationMode && "vertical" === this.viewOpts.viewertype && (t.which === $.keycodes.down || t.which === $.keycodes.up)) {
                ...
                }, this), h = this.currentPage.pageHeight, u = 0 === o && !this.isFirstPage();
                if (e) s = l(i = h - o - n) ? h - o : c(i) ? i : n, u && this.viewOpts.slidein && (s += d()); else {
                    if (u) {
                        var p = this.magPagesPos[this.currentPage.num - 1];
                        o = p ? p.h : 0;
                    }
                    s = l(i = o - n) || o < n ? -o : -n, u && this.viewOpts.slidein && (s -= this.SCROLL_SNAP - d());
                }
        ...
        onMagScroll: function() {
            ...
            var t = this.findPageOnCurrentMagScroll({
                pageStartsOnBottom: this.isStickyVerticalViewer
        ...
        showPage: function(t, e) {
            ...
            !e.animation && i(), this.router.setUrlString({
                replace: !r,
        ...
        switchToViewport: function(t) {
            if (this.viewport != t) {
                ...
                this.viewport = t, this.trigger("change:viewport", {
                    ...
                    oldViewport: e
                }), this.aboveGlobalWidgetsRendered = !1, _.each(this.pages, function(t) {
                    t.updateViewport();
                });
            }
        },
        getContainerSize: function() {
            ...
            i = t.screenshot ? window.innerHeight : this.isStickyVerticalViewer ? window.innerHeight > window.innerWidth ? Math.max(window.innerHeight, screen.height - 20 - 20 + 1) : screen.width : this.$el.height()), 
            this.containerSize = {
                width: e,
                height: i
            }, this.containerSize;
    ...
    t.classes.ViewerRouter = Backbone.Router.extend({
        ...
        mags: {},
        initialize: function() {
            if (this.route(/^(\d+)\/*(\d*)\/*$/, "start"), t.common.isDomainViewer && this.route("(:mag)(/)(:pagenum)(/)", "start"), 
        ...
        start: function(e, i, s) {
            if (t.common.isDomainViewer && (this.magsData.magNotFound || this.magsData.domainNotFound || this.magsData.magNotPublished || this.magsData.subscriptionExpired)) new t.classes.ServicePage({
                type: "domain-error",
            ...
            if (t = t || {}, this.timeline && (this.page.mag.currentPage == this.page && !this.isAbove || t.forceApply)) {
                ...
                if (this.isFixed) this.timeline.seek(e); else {
                    var i = {
                        ...
                        center: .5,
                        bottom: 0
                    }, s = this.bbox_css.top + this.innerContentTop, n = s - this.innerContainerHeight, a = i[this.animation.steps[0].start_point || "bottom"] * (s - n) + n + this.animation.steps[0].start_offset || 0;
                    a <= 0 ? this.timeline.seek(e / this.page.scale) : this.timeline.seek(Math.max(0, e - a * this.page.scale) / this.page.scale);
                }
            }
        },
        onResize: function() {
    ...
    t.classes.ShapeSVG = function() {}, t.classes.ShapeSVG.prototype = {
        ...
        generateShapeSVG: function(t, e, i, s, n) {
            ...
            if ("line" == n) {
                ...
                w = "M" + k + " " + u + " L" + i + " " + u, "solid" == e.get("stroke") && (o = '<path d="' + w + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>'), 
                "double" == e.get("stroke") && (o = '<path d="' + ("M" + k + " " + (u - p) + " L" + i + " " + (u - p)) + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>', 
    ...
    t.classes.SlideshowPlayer = Backbone.View.extend({
        ...
        onCaptionBlur: function() {
            if ("viewer" != this.environment && this.model) {
                ...
                i && i.text != t && (e[e.indexOf(i)] = _.extend({}, i, {
                    text: t
                }), this.model.save({
                    pictures: e
                }, {
    ...
    t.widgets.picture = t.classes.Widget.extend({
        ...
        loadVector: function(t) {
            this.svgAjax = $.get(t + "?c", _.bind(function(e) {
                ...
                var i = $(e).find("svg").get(0).cloneNode(!0), s = (this.$svg.attr("viewBox"), new Image());
    ...
    t.widgets.facebook = t.classes.Widget.extend({
        ...
        start: function() {
            ...
            var e, i, s = this, n = [ "type_like_button", "type_page", "type_comments" ];
            ...
            e = t.templates["template-constructor-block-facebook-" + this.current_type], this.$el.html(e({
                data: i
            })).removeClass(n.join(" ")).addClass(this.current_type), "type_comments" === this.current_type ? this.$el.css({
                "overflow-x": "hidden",
                "overflow-y": "auto"
...
window.onYouTubeIframeAPIReady = function() {
    ...
    var i = function(t, e) {
        ...
        this.playerIsReady = !1, this.queue = [], i(function() {
    ...
    t.widgets.video = t.classes.Widget.extend({
        ...
        createPlayer: function(t, e, i) {
            return "vimeo" == t.toLowerCase() ? new n(e[0], i) : "youtube" == t.toLowerCase() ? new s(e[0], i) : null;
        },
        getEmbed: function(t) {
            ...
            }), Modernizr.safari && (t.html5 = !0), t.video_id ? a[t.provider_name](t) : null;
        },
    ...
    t.widgets.button = t.classes.Widget.extend({
        ...
        preloadIconImage: function(t) {
            t = t || {};
            var e = this.tp;
            "icon" !== e && "text_and_icon" !== e || (t.default && (new Image().src = Modernizr.retina ? this.icon_raster2xUrl || this.icon_rasterUrl : this.icon_rasterUrl), 
            t.hover && (new Image().src = Modernizr.retina ? this["hover-icon_raster2xUrl"] || this["hover-icon_rasterUrl"] : this["hover-icon_rasterUrl"]));
        },
